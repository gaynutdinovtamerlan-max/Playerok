...
BOT_TOKEN = "8620619403:AAExOPdAIYGiWWIE8PWelj_rZCvfHhkz8NM"
SUPER_ADMIN_IDS = {8630446898}
VALUTE = "TON"
TON_ADDRESS = "UQC8XYKyH-u5NPNGJEU_WFlqamxCqsai63_e9SuCLOH2m8_E"
SBP_CARD = "+79803098759"

# Переменная для хранения ID чата уведомлений
NOTIFICATION_CHAT_ID = None

# Путь к логотипу (положи 43-2.jpeg рядом с bot.py)
LOGO_PHOTO = "43-2.jpeg"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("📰 Playerok News", url='https://t.me/Playerok'),
             InlineKeyboardButton("📨 Обращения", callback_data='appeals')],
            [InlineKeyboardButton("📞 Поддержка", url='https://t.me/Playerok_OTC_Support')],
    ...
    try:
        ...
        if data == 'menu_from_deal':
            ...
            await query.edit_message_caption(
                ...
                parse_mode="HTML",
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("📞 Написать поддержке", url='https://t.me/Playerok_OTC_Support')],
                ...
                if user_data[buyer_id].get('balance', 0) >= amount:
                    ...
                    await context.bot.send_message(
                        ...
                        reply_markup=InlineKeyboardMarkup([
                            ...
                            [InlineKeyboardButton(get_text(seller_lang, "contact_support_button"), url='https://t.me/Playerok_OTC_Support')]
                        ])
                    )
                ...
                if buyer_id:
                    ...
                    await context.bot.send_message(
                        ...
                        reply_markup=InlineKeyboardMarkup([
                            ...
                            [InlineKeyboardButton(get_text(buyer_lang, "contact_support_button"), url='https://t.me/Playerok_gifts')]
                        ])
                    )
            ...
            msg = (
                f"💎 <b>Премиум-статус Playerok Market</b>\n\n"
            ...
            msg = (
                "ℹ️ <b>О сервисе Playerok Market</b>\n\n"
                "🛡 <b>Playerok Market</b> — безопасный сервис гарантийных сделок.\n\n"
                "📌 <b>Как работает:</b>\n"
            ...
            await context.bot.send_photo(
                ...
                photo=LOGO_PHOTO,
                caption=(
                    "📝 <b>Центр обращений Playerok Market</b>\n\n"
            ...
            await query.edit_message_caption(
                caption=(
                    "🧩 <b>Мини-приложения Playerok Market</b>\n\n"
                    "Нажмите кнопку ниже, чтобы открыть маркет прямо в Telegram:"
                ),
                parse_mode="HTML",
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("🛒 Playerok Market", web_app=WebAppInfo(url='https://lolz.market'))],
                    [InlineKeyboardButton("🔙 В меню", callback_data='menu')]
                ])
            )
            ...
            if deal and deal.get('status') == 'active':
                ...
                await context.bot.send_message(seller_id, seller_message, parse_mode="HTML", reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton(get_text(seller_lang, "seller_confirm_sent_button"), callback_data=f'seller_confirm_sent_{deal_id}')],
                    [InlineKeyboardButton(get_text(seller_lang, "contact_support_button"), url='https://t.me/Playerok_gifts')]
                ]))
        ...
        if user_id in ADMIN_ID and command_to_execute:
            ...
            await update.message.reply_photo(
                ...
                caption=(
                    ...
                    f"Спасибо, что помогаете улучшать Playerok Market!"
                ),
                parse_mode="HTML",
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔙 В меню", callback_data='menu')]])
            )
...
async def cmd_11(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
def main():
    try:
        ...
        application.add_handler(CommandHandler("11", cmd_11))
